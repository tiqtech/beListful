...
RestfulThings.Thing = function(id, spec, handlers){
    ...
    this.handlers = {
        "get": (handlers.get) ? handlers.get.bind(this) : undefined,
        "post": (handlers.post) ? handlers.post.bind(this) : undefined,
        "put": (handlers.put) ? handlers.put.bind(this) : undefined,
        "del": (handlers.del) ? handlers.del.bind(this) : undefined
    }
}
